...
\author{Thomas Bugge \\ \normalsize\href{mailto:thomas@bgg-mail.de}{thomas@bgg-mail.de} \\[4pt] \normalsize Version 0.22}
\date{August 2026}
...
\begin{enumerate}[nosep]
  \item APK von \url{https://bgg-schule.de/namio/} herunterladen und installieren
        (\ui{Aus dieser Quelle installieren} erlauben). Updates: Seite erneut öffnen oder
        die Adresse in Obtainium als Quelle eintragen.
...
\begin{itemize}[nosep]
  \item \textbf{Kind setzen}: Kind in der Leiste oder auf einem Platz antippen, dann einen freien Platz antippen. Oder ziehen.
  \item \textbf{Kinder tauschen}: beide Kinder antippen, dann oben \ui{Tauschen} bestätigen.
        Ziehen auf ein besetztes Ziel tauscht direkt.
  \item \textbf{Tisch markieren}: Tisch antippen (bei belegtem Platz lange drücken; Langdruck mit
        anschließendem Ziehen verschiebt den Tisch gleich mit). Werkzeugleiste oben:
...
\bigskip
\noindent\small Fragen, Fehler, Wünsche: Thomas Bugge · \href{mailto:thomas@bgg-mail.de}{thomas@bgg-mail.de}
