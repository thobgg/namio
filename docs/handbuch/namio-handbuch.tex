...
\begin{enumerate}[nosep]
  ...
  \item Die Demoklasse \ui{7b} (24 Kinder mit Avataren, fertiger Sitzplan) ist zum Ausprobieren da.
        Du kannst sie jederzeit löschen (\ui{⋮} an der Klasse); sie kommt nicht zurück.
\end{enumerate}
...
\begin{itemize}[nosep]
  ...
  \item \ui{⋮} an der Karte: Klasse löschen -- samt Schülern, Fotos, Lernständen und Sitzplänen.
...
\ui{Mischen} (nach Rückfrage), Zoom (zwei Finger oder Lupen), \ui{⋮} $\to$ \ui{Als PDF speichern}.
...
\begin{itemize}[nosep]
  ...
  \item \ui{Rückgängig} für die letzten 30 Schritte. \ui{⋮}: neuer Plan, Name/Raum/Einrasten, Plan kopieren, als Standard, löschen.
\end{itemize}
...
\textbf{Kann ich Fotos für alle Kinder auf einmal machen?} Aktuell pro Kind über das Schülerdetail. Eine
„Fotorunde“ (Kamera bleibt offen, Namio zeigt das nächste Kind an) ist geplant.
...
\vfill
\small Quelltext und Screenshots: \url{https://github.com/thobgg/namio}
\end{document}
